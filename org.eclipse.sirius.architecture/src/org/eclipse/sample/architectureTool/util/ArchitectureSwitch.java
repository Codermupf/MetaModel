...
public class ArchitectureSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ArchitecturePackage.CLASS: {
				org.eclipse.sample.architectureTool.Class class_ = (org.eclipse.sample.architectureTool.Class)theEObject;
				T result = caseClass(class_);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArchitecturePackage.SYSTEM: {
				org.eclipse.sample.architectureTool.System system = (org.eclipse.sample.architectureTool.System)theEObject;
			...
			case ArchitecturePackage.INTER_FACE: {
				InterFace interFace = (InterFace)theEObject;
				T result = caseInterFace(interFace);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArchitecturePackage.IN_PORT: {
			...
			case ArchitecturePackage.OUT_PORT: {
	 ...
	 * @generated
	 */
	public T caseClass(org.eclipse.sample.architectureTool.Class object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseSystem(org.eclipse.sample.architectureTool.System object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Inter Face</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Inter Face</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
