...
public class ArchitectureFactoryImpl extends EFactoryImpl implements ArchitectureFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ArchitecturePackage.ARCHITECTURE_GRAPH: return createarchitectureGraph();
	...
	public architectureGraph createarchitectureGraph() {
		architectureGraphImpl architectureGraph = new architectureGraphImpl();
	 ...
	 * @generated
	 */
	public org.eclipse.sample.architecture.Class createClass() {
