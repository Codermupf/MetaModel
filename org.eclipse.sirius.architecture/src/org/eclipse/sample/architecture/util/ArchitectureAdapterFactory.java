/**
 */
package org.eclipse.sample.architecture.util;
...
import org.eclipse.sample.architecture.*;
...
public class ArchitectureAdapterFactory extends AdapterFactoryImpl {
	...
	protected ArchitectureSwitch<Adapter> modelSwitch =
		new ArchitectureSwitch<Adapter>() {
			@Override
			public Adapter casearchitectureGraph(architectureGraph object) {
				return createarchitectureGraphAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseClass(org.eclipse.sample.architecture.Class object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.sample.architecture.architectureGraph <em>architecture Graph</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createarchitectureGraphAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.sample.architecture.Component <em>Component</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.sample.architecture.Class <em>Class</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
