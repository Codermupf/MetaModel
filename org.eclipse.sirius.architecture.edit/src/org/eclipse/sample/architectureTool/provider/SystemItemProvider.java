...
/**
 * This is the item provider adapter for a {@link org.eclipse.sample.architectureTool.System} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SystemItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_System_subSystem_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_System_subSystem_feature", "_UI_System_type"),
				 ArchitecturePackage.Literals.SYSTEM__SUB_SYSTEM,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ArchitecturePackage.Literals.SYSTEM__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ArchitecturePackage.Literals.SYSTEM__COMPONENT_OF_SYSTEM);
	...
	public String getText(Object object) {
		String label = ((org.eclipse.sample.architectureTool.System)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(org.eclipse.sample.architectureTool.System.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ArchitecturePackage.Literals.SYSTEM__COMPONENT_OF_SYSTEM,
